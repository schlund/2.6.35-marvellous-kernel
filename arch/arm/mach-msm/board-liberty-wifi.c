...
int liberty_wifi_get_mac_addr(unsigned char *buf);
...
static struct wifi_platform_data liberty_wifi_control = {
	...
	.get_mac_addr	= liberty_wifi_get_mac_addr,
	.dot11n_enable  = 1,
};
